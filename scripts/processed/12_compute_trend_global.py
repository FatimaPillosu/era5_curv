...
############################################################################
# DESCRIPTION CODE
# 12_compute_trend_global.py computes the trend for the curv diagnostic, for a global field.
#Runtime: ~ 3 hours.
...
year_s = 1950
year_f = 2024
radius_list = [1000, 500, 2000, 3000]
season_list = ["DJF", "MAM", "JJA", "SON"]
dir_in = os.path.join(DATA_COMPUTE_DIR, "08_average_curv")
dir_out = os.path.join(DATA_COMPUTE_DIR, "12_trend_global")
############################################################################
