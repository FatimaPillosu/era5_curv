...
#################################################################################################################
# DESCRIPTION CODE
# 08_compute_average_curv.py computed the yearly average for the curv diagnostic, at each grid-point.
#Runtime: ~ 1.5 hours.
...
dir_out = os.path.join(DATA_COMPUTE_DIR, "08_average_curv")
#################################################################################################################
